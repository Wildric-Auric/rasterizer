...
#define def_op1_v3(type, op) type operator op (const type& other) {return type(x op other.x, y op other.y, z op other.z);} 
#define def_op2_v3(type, op) void operator op##=(const type& other) { x op##= other.x, y op##= other.y, z op##= other.z;} 

#define def_op1_v2(type, op) type operator op (const type& other) {return type(x op other.x, y op other.y);} 
